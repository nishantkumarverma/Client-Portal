...
$("#booking-table tbody").append('<tr><td>'+value.CustomerName+'</td><td>'+value.LocationName+'</td><td>'+days+'</td><td>'+value.SlotStartTime+'</td><td>'+value.SlotEndTime+'</td><td>'+value.TotalSeconds+'</td><td>'+value.SubTotal+'</td><td>'+yesText+'</td><td>'+isPaid+'</td><td></td></tr>');
});
		 },
