  ...
  <div id="register-page" class="row" style="display:none;">
    <div class="col s12 z-depth-4 card-panel">
      <form class="login-form">
		...
		<div class="row margin">
         <div class="input-field col s12">
         <input id="adminname" type="text" class="validate">
         <label for="fullname">Full Name</label>
         </div>
        </div>
        <div class="row margin">
         <div class="input-field col s12">
         <input id="adminemail" type="text" class="validate">
        ...
        <div class="row">
          <div class="input-field col s12">
            <button type="button" onclick="registeradmin();" class="btn waves-effect waves-light col s12">Register</button>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s6 m6 l6">
...
<script type="text/javascript" src="<?= PUBLIC_ROOT ?>js/admin/app.js"></script>
	<script type="text/javascript" src="<?= PUBLIC_ROOT ?>js/admin/login.js"></script>
</body>
