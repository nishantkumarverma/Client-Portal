 <!-- START LEFT SIDEBAR NAV-->
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <li class="bold"><a href="<?php echo $app->urlFor("customer-dashboard"); ?>" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard</a>
                    </li>
                      <li class="bold"><a href="<?php echo $app->urlFor("newbooking"); ?>" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> New Booking</a>
                    </li>
