...
<head>
    ...
    <link href="<?= PUBLIC_ROOT ?>js/plugins/material-preloader/materialPreloader.css" type="text/css" rel="stylesheet" media="screen,projection">
...
echo "<script>var userJson=".json_encode($_SESSION['UserJson']).";</script>";
}
?>
</head>
